...
import { DollarSign, Percent, Save, TrendingUp, Settings2 } from "lucide-react";
            ...
            <Card className="bg-neutral-800 border-neutral-700">
                <CardHeader className="pb-2">
                    <CardTitle className="text-sm font-medium text-neutral-400 uppercase tracking-widest">
                        Total Histórico (Todas as Comissões)
                    </CardTitle>
                </CardHeader>
                <CardContent>
                ...
                <CardContent className="space-y-6">
                    ...
                    >
                        <div>
                            ...
                            <Label
                                htmlFor="tiers"
                                className="flex flex-col items-center justify-between rounded-md border-2 border-neutral-700 bg-neutral-900/50 p-4 hover:bg-neutral-800 hover:text-white peer-data-[state=checked]:border-green-500 peer-data-[state=checked]:text-green-500 cursor-pointer transition-all"
                            >
                        ...
                        <div className="animate-in fade-in slide-in-from-top-2">
                            ...
                            <div className="space-y-3">
                                ...
                                {tiers.map((tier, index) => (
                                    <div key={index} className="grid grid-cols-12 gap-4 items-center bg-neutral-900 p-3 rounded-lg border border-neutral-700">
                                        <div className="col-span-7 relative">
                                            <span className="absolute left-3 top-2.5 text-neutral-500 text-xs">Até R$</span>
                                            <Input
                                                type="number"
                                                value={tier.max}
                                                onChange={e => updateTier(index, 'max', e.target.value)}
                                                className="pl-12 bg-neutral-950 border-neutral-700 text-white"
                                            />
                                        </div>
                                        <div className="col-span-5 relative">
                                            <Input
                                                ...
                                                className="bg-neutral-950 border-neutral-700 text-yellow-400 font-bold pr-8 text-right"
                                            />
                    ...
                    {commissionType === 'fixed' && (
                        <div className="animate-in fade-in slide-in-from-top-2 p-6 bg-neutral-900 rounded-lg border border-neutral-700">
                            ...
                            <div className="relative max-w-xs">
                                ...
                                <Input
                                    ...
                                    className="pl-10 h-14 bg-neutral-950 border-neutral-700 text-white font-black text-2xl"
                                />
                            </div>
